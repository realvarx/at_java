...
public class EncryptionUtil {
    ...
    public static String signSHA256RSA(String value, String privateKeyBase64) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, SignatureException {
        PrivateKey privateKey = _privateKeyFromBase64(privateKeyBase64);
